...
import { Context, StoriesContext as StoriesContextInterface } from '../interfaces/index'
...
export default function () {
    ...
    const { width, height, loop, currentIndex, isPaused, keyboardNavigation, preventDefault, storyContainerStyles = {} } = useContext<Context>(GlobalContext);
